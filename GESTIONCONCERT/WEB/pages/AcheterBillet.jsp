    ...
    <div class="container px-5">
        ...
        <div class="bg-light rounded-3 py-5 px-4 px-md-5 mb-5">
            <div class="text-center mb-5">
                ...
                <p class="lead fw-normal text-muted mb-0">Acheter votre billet</p>
            </div>
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-8 col-xl-6">
                    <form id="contactForm" action="payer" data-sb-form-api-token="API_TOKEN" method="post">
                        <!-- Name input-->
                       <div class="form-floating mb-3">
                        ...
                        <!-- Email address input-->
                        <div class="form-floating mb-3">
                            <input class="form-control" id="places" name="place" type="text" placeholder="..." data-sb-validations="required,number" />
                        ...
                        <div class="d-grid"><button class="btn btn-primary btn-lg able" id="submitButton" type="submit">Payer</button></div>
                    </form>
                </div>
            </div>
        </div>
